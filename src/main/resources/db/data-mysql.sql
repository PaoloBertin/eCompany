...
INSERT INTO aggregates(aggregate_name)
    VALUES ('Users'),
           ('Administrators');

-- Map the aggregates to Roles
INSERT INTO aggregate_authorities(aggregate_id, authority)
    SELECT id,'ROLE_USER' FROM aggregates WHERE aggregate_name='Users';
-- Administrators are both a ROLE_USER and ROLE_ADMIN
INSERT INTO aggregate_authorities(aggregate_id, authority)
    SELECT id,'ROLE_USER' FROM aggregates WHERE aggregate_name='Administrators';
INSERT INTO aggregate_authorities(aggregate_id, authority)
    SELECT id,'ROLE_ADMIN' FROM aggregates WHERE aggregate_name='Administrators';

-- Map the users to aggregates
INSERT INTO aggregate_members(aggregate_id, username)
    SELECT id,'admin' FROM aggregates WHERE aggregate_name='Administrators';
INSERT INTO aggregate_members(aggregate_id, username)
    SELECT id,'user.ecompany' FROM aggregates WHERE aggregate_name='Users';
INSERT INTO aggregate_members(aggregate_id, username)
    SELECT id,'mario.rossi' FROM aggregates WHERE aggregate_name='Users';
INSERT INTO aggregate_members(aggregate_id, username)
    SELECT id,'giuseppe.verdi' FROM aggregates WHERE aggregate_name='Users';
INSERT INTO aggregate_members(aggregate_id, username)
    SELECT id,'giuseppe.garibaldi' FROM aggregates WHERE aggregate_name='Users';
...
INSERT INTO products(id, name, subtitle, description, product_code, price, image, category_id)
    VALUES ( 1, 'Da Visual Basic a Java', '', 'Con Visual Basic oggi si possono produrre applicazioni allo stato dell''arte: event-driven, Internet-ready, con logica ad oggetti, o meglio a componenti. Tuttavia Visual Basic ha una limitazione evidente: funziona solo in ambienti Microsoft', '8883780450', 29.90, LOAD_FILE('classpath:static/images/cover/vb2java.jpg'),1),
           ( 2, 'Resurrection', '', 'Even though it under performed at the box office last Christmas, I really enjoyed "Star Trek: Insurrection." Maybe it was the title. Maybe it was the time of year.', '8883780451', 39.90, LOAD_FILE('classpath:static/images/cover/resurrection.jpg'), 2),
           ( 3, 'Java Web Services', '', 'Java web services" consente allo sviluppatore Java di entrare nel mondo del Web Services.', '1449365116', 29.90, LOAD_FILE('classpath:static/images/cover/jws.jpg'), 1),
           ( 4, 'Enterprise JavaBeans', '', 'Enterprise JavaBeans e'' la guida definitiva a EJB 2.0, completa dei piu'' recenti sviluppi tecnologici.', '0596158025', 49.90, LOAD_FILE('classpath:static/images/cover/ejb.jpg'), 1),
           ( 5, 'Java Server Pages', '', 'Gli sviluppatori hanno compreso il potenziale di Enterprise Java per la costruzione di applicazioni distribuite fin dal 1999.', '0596158035', 49.90, LOAD_FILE('classpath:static/images/cover/jsp.jpg'), 1),
           ( 6, 'When dream and day unite', '', 'Il primo album dei Dream Theater', '0596158045', 19.90, LOAD_FILE('classpath:static/images/cover/When_dream_and_day_unite.jpg'), 2),
           ( 7, 'Images and world', '', 'Il secondo album dei Dream Theater', '0596158055', 19.90, LOAD_FILE('classpath:static/images/cover/Images_and_Words.jpg'), 2),
           ( 8, 'Awake', '', 'Il terzo album dei Dream Theater', '0596158065', 19.90, LOAD_FILE('classpath:static/images/cover/Awake.jpg'), 2),
           ( 9, 'A Change of season', '', 'Il quarto album dei Dream Theater', '0596158075', 19.90, LOAD_FILE('classpath:static/images/cover/A_Change_of_ Seasons.jpg'), 2),
           (10, 'Falling into infinity', '', 'Il quinto album dei Dream Theater', '0596158085', 19.90, LOAD_FILE('classpath:static/images/cover/Falling_into_Infinity.jpg'), 2),
           (11, 'Live in Marquee', '', 'Il sesto album dei Dream Theater', '0596158095', 19.90, LOAD_FILE('classpath:static/images/cover/Live_at_the_Marquee.jpg'), 2),
           (12, 'Scenes from a memory', '', 'Il settimo album dei Dream Theater', '0596158105', 19.90, LOAD_FILE('classpath:static/images/cover/Scenes_from_a_Memory.jpg'), 2),
           (13, 'Solo. A Star Wars Story', '', 'Tempi duri per la Galassia, forze oscure tramano nell''ombra e minacciano la Repubblica.', '0596158125', 15.90, LOAD_FILE('classpath:static/images/cover/Solo_A_Star_Wars_Story.jpg'), 3),
           (14, 'Ready Player One', '', 'Nel 2045,  il mondo reale e'' un luogo impervio e ostile. Gli unici momenti in cui Wade Watts si sente veramente vivo e'' quando si immerge in OASIS, un intero universo virtuale dove evade la maggior parte dell''umanita'' per trascorre le proprie giornate.', '0596158135', 15.90, LOAD_FILE('classpath:static/images/cover/ready-player-one.jpg'), 3),
           (15, 'L''isola dei cani', '', 'Un ragazzo parte alla ricerca del suo cane, esiliato per via di un''influenza canina. Insieme, proveranno a sovvertire le regole del sistema', '0596158145', 16.90, LOAD_FILE('classpath:static/images/cover/isola-dei-cani.jpg'), 3),
           (16, 'Etica del discorso', '', 'Se l''esigenza di capire e interpretare la vita sociale sta oggi al centro ella filosofia e delle scienze umane, in questo libro Habermas offre concrete indicazioni', '0596158155', 16.15, LOAD_FILE('classpath:static/images/cover/etica-del-discorso.jpg'), 1),
           (17, 'Stime dei lavori edili.', '', 'Milano, Hoepli, 1917, 16mo legatura editoriale originale, pp. XII-325-64. Prima edizione.', '0596158165', 25.00, LOAD_FILE('classpath:static/images/cover/stima-dei-lavori-edili.jpg'), 1),
           (18, 'Manuale di Java 9', '', 'Il Manuale di Java 9 e'' stato strutturato per soddisfare le aspettative di aspiranti programmatori: nulla e'' dato per scontato, e'' possibile imparare a programmare partendo da zero', '9788820383022', 42.00, LOAD_FILE('classpath:static/images/cover/manuale-java9.jpg'), 1),
           (19, 'Dai fondamenti agli oggetti', 'Corso di programmazione Java', 'Questo testo e'' un vero e proprio corso di programmazione accessibile anche a chi non abbia alcuna conoscenza della materia, e nel contempo tocca e approfondisce le tematiche e gli aspetti fondamentali della programmazione. ', '9788865188996', 33.15, LOAD_FILE('classpath:static/images/cover/dai-fondamenti-agli-oggetti.jpg'), 1),
           (20, 'Applicare UML e i pattern', 'Analisi e progettazione orientata agli oggetti', 'Scritto per la prima volta nell''edizione originale nel 1995, questo testo negli anni e'' stato tradotto in piu'' di 20 lingue.', '9788891901033', 33.15, LOAD_FILE('classpath:static/images/cover/applicare-uml-e-i-pattern.jpg'), 1),
           (21, 'Ba Martina Spaghettina', '', 'Martina si e'' appena svegliata: una rapida pettinata con la spazzola e ha subito fame. Se le accarezzi il pancino lei ti rispondero'' e ti faro'' capire quanto desidera la sua pappa.', '5010993438136', 43, LOAD_FILE('classpath:static/images/cover/ba-martina-spaghettina.jpg'), 4),
           (22, 'Agenda giornaliera 2019', '', 'L''agenda giornaliera Moleskine copre tutto l''anno, da gennaio a dicembre.', '8058341715642', 19, LOAD_FILE('classpath:static/images/cover/agenda-giornaliera-2020.jpg'), 5),
           (23, 'Cuffie iTek Taurus H300', '', 'iTek TAURUS H300 sono cuffie leggere, regolabili, e con materiale soffice in simil-pelle per dare il massimo comfort nell''utilizzo anche di lunga durata', '8032539913843', 24, LOAD_FILE('classpath:static/images/cover/cuffie-iTek-Taurus-H300.jpg'), 6),
           (24, 'Intelligenza artificiale - Vol. 1', '', 'Un classico nell''ambito della letteratura sull''intelligenza artificiale, apprezzato per la sua presentazione equilibrata e precisa e per l''ampiezza e l''approfondimento dei contenuti.', '9788871925936', 40, LOAD_FILE('classpath:static/images/cover/9788871925936.jpg'), 1),
           (25, 'Fondamenti di controlli automatici', '', 'Questo libro presenta gli elementi di base della teoria dei sistemi e del controllo.', '9788838668821', 49, LOAD_FILE('classpath:static/images/cover/9788838668821.jpg'), 1),
           (26, 'Microeconomia', '', 'La sesta edizione italiana, basata su Frank Cartwright Global Edition, presenta diverse interessanti novità di rilievo rispetto alla precedente.', '9788838693243', 52, LOAD_FILE('classpath:static/images/cover/9788838693243.jpg'), 1),
           (27, 'Statistica e calcolo con R', '', 'Questo libro è il risultato dell''esperienza di diversi anni di insegnamento, presso l''Università di Bologna, in corsi di introduzione all''informatica e di programmazione per il calcolo numerico (AM) e di statistica (ELP).', '9788838693984', 29, LOAD_FILE('classpath:static/images/cover/9788838693984.jpg'), 1),
           (28, 'La matematica degli dèi e gli algoritmi degli uomini', '', 'I numeri sono un''invenzione della mente o una scoperta con cui la mente accerta l''esistenza di qualcosa che è nel mondo?', '9788845978289', 7.99, LOAD_FILE('classpath:static/images/cover/9788845978289.jpg'), 1),
           (29, 'Caos', '', 'Dare senso al mondo, alle esperienze quotidiane e, ancor più, agli eventi che ci sorprendono o dai quali può dipendere la nostra sopravvivenza', '9788815358776', 10.99, LOAD_FILE('classpath:static/images/cover/9788815358776.jpg'), 1),
           (30, 'Lezioni di matematica attuariale delle assicurazioni danni', '', 'Lezioni di matematica attuariale delle assicurazioni danni', '9788867807048', 10.99, LOAD_FILE('classpath:static/images/cover/9788867807048.jpg'), 1),
           (31, 'Logica matematica', '', 'In questo libro sono presentate tutte le sfaccettature della logica matematica', '9781523624935', 1.99, LOAD_FILE('classpath:static/images/cover/9781523624935.jpg'), 1),
           (32, 'I teoremi di incompletezza', '', 'Nel 1930 i teoremi di incompletezza di Kurt Gödel cambiarono il corso della filosofia della scienza.', '9788815352101', 8.49, LOAD_FILE('classpath:static/images/cover/9788815352101.jpg'), 1),
           (33, 'Dalla macchina di Turing a P/NP', '', 'Dalla macchina di Turing a P/NP', '9788838691041', 12.00, LOAD_FILE('classpath:static/images/cover/9788838691041.jpg'), 1),
           (34, 'L''enigma di Turing', 'Genesi e apologia di un genio matematico', 'Se volessimo trovare un esempio concreto di autentica vita vissuta all’insegna dell’art pour l’art, motto dei simbolisti e decadentisti del XIX secolo, Turing sarebbe indubbiamente un caso paradigmatico', '9788857554655', 12.99, LOAD_FILE('classpath:static/images/cover/9788857554655.jpg'), 1),
           (35, 'Oggetti concorrenza distribuzione.', '', 'Questo testo raccoglie le note del corso di programmazione concorrente e distribuita', '9788874888030', 24.70, LOAD_FILE('classpath:static/images/cover/9788874888030.jpg'), 1),
           (36, 'Accetto miracoli', '', 'Accetto Miracoli è con ogni probabilità, il disco più atteso di questo Natale 2019', '0602508304392', 24.70, LOAD_FILE('classpath:static/images/cover/0602508304392.jpg'), 2),
           (37, 'Colpa delle favole', '', 'Dopo aver pubblicato “I TUOI PARTICOLARI”, singolo già disco di platino con cui ha partecipato alla sessantanovesima edizione del Festival di Sanremo, ULTIMO anticipa ai suoi fan questo nuovo inedito', '3615936866780', 15.75, LOAD_FILE('classpath:static/images/cover/3615936866780.jpg'), 2),
           (38, 'Mina Fossati', '', 'Mina e Fossati insieme, per un nuovo album di inediti.', '0194397022421', 26.50, LOAD_FILE('classpath:static/images/cover/0194397022421.jpg'), 2),
           (39, 'Mission', '', 'Nel cuore del continente sud americano, alla metà del XVIII secolo, una comunità di indios capeggiata da alcuni gesuiti cerca di opporsi alle mire espansionistiche di spagnoli e portoghesi.', '5051891126862', 9.99, LOAD_FILE('classpath:static/images/cover/5051891126862.jpg'), 3),
           (40, 'Maraviglioso Boccaccio', '', '1348: a Firenze infuria la peste, mietendo sempre più vittime. Un gruppo di 10 giovani cerca rifugio in una casa di campagna, per tentare di sfuggire al contagio.', '8057092004869', 9.99, LOAD_FILE('classpath:static/images/cover/8057092004869.jpg'), 3),
           (41, 'Elizabeth', '', 'Elisabetta I per difendere il suo regno deve affrontare diversi ostacoli.', '5050582518832', 9.99, LOAD_FILE('classpath:static/images/cover/5050582518832.jpg'), 3),
           (42, 'Kagemusha', '', 'Il principe Shingen, che sogna di riunificare il Giappone nel Cinquecento, ha al suo seguito un sosia grazie al quale riesce a mantenere segreta la morte del Re per ingannare il nemico e salvaguardare il regno', '8010312035869', 9.99, LOAD_FILE('classpath:static/images/cover/8010312035869.jpg'), 3),
           (43, 'Le crociate', '', 'Balian, un giovane fabbro francese, disperato per la perdita della moglie e del figlio ancora piccolo, decide di seguire nella sua sacra missione colui che dice di essere il suo vero padre', '5051891084803', 9.99, LOAD_FILE('classpath:static/images/cover/5051891084803.jpg'), 3),
           (44, 'Alexander', '', 'La storia del conquistatore più famoso della storia, Alessandro, un uomo che a 27 anni riesce a impadronirsi quasi per intero del mondo allora conosciuto', '7321958389362', 9.99, LOAD_FILE('classpath:static/images/cover/7321958389362.jpg'), 3),
           (45, 'Robin Hood', '', 'In un''epoca di oppressione e feroce tirannia, un fuorilegge divenne l''eroe che salvò una nazione e ispirò generazioni a combattere per la libertà', '5053083017149', 9.99, LOAD_FILE('classpath:static/images/cover/5053083017149.jpg'), 3),
           (46, 'Il gladiatore', '', 'Maximus è il generale romano prediletto da Marco Aurelio, ma proprio per questo odiato da Commodo, figlio dell''imperatore.', '5053083156510', 9.99, LOAD_FILE('classpath:static/images/cover/5053083156510.jpg'), 3),
           (47, 'The Eagle', '', 'Nel 140 d.C. l''Impero Romano si estende fino alla Britannia, anche se non ha il controllo di tutte le regioni e l''estremo nord è governato dalle tribù ribelli della Caledonia.', '8032807067841', 9.99, LOAD_FILE('classpath:static/images/cover/8032807067841.jpg'), 3),
           (48, 'Cyber Flipper', '', 'Flipper elettronico con luci e suoni', '8001097539673', 45.99, LOAD_FILE('classpath:static/images/cover/8001097539673.jpg'), 4),
           (49, 'Monopoly', '', 'Monopoly, il gioco di contrattazione più famoso del mondo.', '5010993414314', 25.00, LOAD_FILE('classpath:static/images/cover/5010993414314.jpg'), 4),
           (50, 'Poker Romano', '', 'I giochi di dadi erano molto popolari nell&rsquoAntica Roma. Dagli schiavi all''Imperatore, tutti vi giocavano.', '8058773201294', 25.00, LOAD_FILE('classpath:static/images/cover/8058773201294.jpg'), 4),
           (51, 'Scacchi Dama Tria', '', 'Game Set Scacchi e Dama Tria 36 x 36 CmContenitore in legno da 36 x 36 cm con scomparti. Scacchiera intarsiata, bifacciale. Pedine e scacchi in legno (altezza Re 65 mm), con regole di gioco', '8001097539093', 29.50, LOAD_FILE('classpath:static/images/cover/8001097539093.jpg'), 4),
           (52, 'Mazzo 52 Carte da Gioco Trevigiane', '', '52 Carte da Gioco TrevigianeMazzo da 52 carte Triestine. Solide e leggere, dalla stampa professionale e dal design unico e inconfondibile costruite interamente in plastica.', '8020320036222', 12.00, LOAD_FILE('classpath:static/images/cover/8020320036222.jpg'), 4),
           (53, 'Carte Da Gioco Ramino Italia', '', 'L''astuccio Ramino Italia Dal Negro include due mazzi da poker in cartoncino.', '8001097210435', 12.00, LOAD_FILE('classpath:static/images/cover/8001097210435.jpg'), 4),
           (54, 'Apple iPhone 11', '', 'Un nuovo sistema a doppia fotocamera, per inquadrare più cose intorno a te.', '0190199221130', 796, LOAD_FILE('classpath:static/images/cover/0190199221130.jpg'), 6);
